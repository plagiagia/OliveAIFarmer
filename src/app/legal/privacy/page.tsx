    ...
    <>
      ...
      <section>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li><strong>Συνομιλίες AI:</strong> τα μηνύματά σας προς τον AI Γεωπόνο και το σχετικό περιεχόμενο του ελαιώνα σας αποστέλλονται στην OpenAI για επεξεργασία. Καταγράφουμε τη συνολική χρήση tokens για έλεγχο κόστους.</li>
      ...
      <section>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li><strong>Copernicus Data Space</strong> (ESA, ΕΕ) — δορυφορικά δεδομένα Sentinel.</li>
